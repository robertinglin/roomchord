...
function usage() {
  console.error('Usage: node shared/frontendCommand.cjs <dev|build|check|test> <app-root> [-- extra args]');
}
...
function splitExtraArgs(args) {
  ...
  if (separator === -1) return { args, extra: [] };
...
module.exports = { main, resolveFromRoots, resolvePackageBin };
